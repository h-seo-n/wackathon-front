...
export const SESSION_HISTORY: Record<number, SessionHistoryResponse> = {
	1: {
		sessionId: 1,
		points: [
			{ lat: 37.5665, lng: 126.978, t: nowMinus(40), actor: "me" },
			...
			{ lat: 37.564, lng: 126.9741, t: nowMinus(20), actor: "me" },
			{ lat: 37.5634, lng: 126.9733, t: nowMinus(15), actor: "me" },
			{ lat: 37.5629, lng: 126.9726, t: nowMinus(10), actor: "partner" },
			{ lat: 37.5624, lng: 126.972, t: nowMinus(5), actor: "partner" },
		],
	},
	2: {
		sessionId: 2,
		points: [
			{ lat: 37.57, lng: 126.983, t: nowMinus(25), actor: "me" },
...
export function listHistoryByDateParam(
	dateParam: string,
